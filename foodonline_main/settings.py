...
#install python-decouple for following configuration
...
EMAIL_USE_TLS = True
# Instead of showing default email we show text as following
DEFAULT_FROM_EMAIL = 'FoodOnline Marketplace <dumy.mail69@gmail.com>'               
